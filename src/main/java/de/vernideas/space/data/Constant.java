...
public final class Constant {
	...
	public static final double EARTH_MANTLE_MAX_DENSITY = 5226.0;
	public static final double EARTH_MANTLE_MIN_DENSITY = 4234.0;
	public static final double EARTH_CRUST_MAX_DENSITY = 3538.0;
	public static final double EARTH_CRUST_MIN_DENSITY = 2300.0;
	// Earth - estimated radius of core and mantle (crust = planet radius) in m
	public static final double EARTH_CORE_RADIUS = 3400000.0;
	public static final double EARTH_MANTLE_RADIUS = 6335000.0;
}
